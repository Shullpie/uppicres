...
async def start(message: Message):
    await message.answer('Здравствуйте! Я бот, предназначенный для реставрации старых фотографий. '
                         'Если хотите, чтобы ваше изображение было обработано, то пришлите его в этот чат.\n\n'
                         ...
                         '❗Ваше изображение будет храниться в памяти сервера только во вреия обработки, '
